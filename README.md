<p align="center">
  <a href="https://pkg.go.dev/github.com/monceaux/fyne/v2?tab=doc" title="Go API Reference" rel="nofollow"><img src="https://img.shields.io/badge/go-documentation-blue.svg?style=flat" alt="Go API Reference"></a>
  ...
  <br />
  <a href="https://goreportcard.com/report/github.com/monceaux/fyne/v2"><img src="https://goreportcard.com/badge/github.com/monceaux/fyne/v2" alt="Code Status" /></a>
...
Using the standard go tools you can install Fyne's core library using:
    ...
    go get github.com/monceaux/fyne/v2@latest
...
To run a showcase of the features of Fyne execute the following:
    ...
    go install github.com/monceaux/fyne/v2/cmd/fyne_demo@latest
    fyne_demo
...
application location you can use the fyne utility and the "install" subcommand.
    ...
    go install github.com/monceaux/fyne/v2/cmd/fyne@latest
    fyne install
...
More documentation is available at the [Fyne developer website](https://developer.fyne.io/) or on [pkg.go.dev](https://pkg.go.dev/github.com/monceaux/fyne/v2?tab=doc).
...
| ------------- | ----------------------------------- | ---------------------------------------------------------------------- |
| fyne_settings | `github.com/monceaux/fyne/v2/cmd/fyne_settings` | A GUI for managing your global Fyne settings like theme and scaling    |
